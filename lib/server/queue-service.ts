...
export async function createVisit(input: { patient: { name: string; age: number; mobile: string; email?: string; bodyTemperature?: number; temperatureUnit?: "F" | "C"; weightKg?: number }; doctorId: string; complaint: string; complaintCategory: ComplaintCategory; departmentId: string }, actorUid: string) {
